...
uniform sampler2D u_firstHalf;
uniform sampler2D u_secondHalf;
...
void main() {
	...
	vec4 mostSigFirstHalfTexel  = texture2D(u_firstHalf,  vec2(float(mostSigCoord.x) + 0.5, mod(float(mostSigCoord.y), u_textureWidth) + 0.5) / u_textureWidth);
	vec4 mostSigSecondHalfTexel = texture2D(u_secondHalf, vec2(float(mostSigCoord.x) + 0.5, mod(float(mostSigCoord.y), u_textureWidth) + 0.5) / u_textureWidth);
	vec4 mostSigTexel = floatGreaterThanOrEqual(float(mostSigCoord.y), 0.0 * u_textureWidth) * floatLessThan(float(mostSigCoord.y), u_textureWidth * 1.0) * mostSigFirstHalfTexel
					  + floatGreaterThanOrEqual(float(mostSigCoord.y), 1.0 * u_textureWidth) * floatLessThan(float(mostSigCoord.y), u_textureWidth * 2.0) * mostSigSecondHalfTexel;
	...
	vec4 firstHalfTexel  = texture2D(u_firstHalf,  vec2(float(targetCoord.x) + 0.5, mod(float(targetCoord.y), u_textureWidth) + 0.5) / u_textureWidth);
	vec4 secondHalfTexel = texture2D(u_secondHalf, vec2(float(targetCoord.x) + 0.5, mod(float(targetCoord.y), u_textureWidth) + 0.5) / u_textureWidth);
	vec4 texel = floatGreaterThanOrEqual(float(targetCoord.y), 0.0 * u_textureWidth) * floatLessThan(float(targetCoord.y), u_textureWidth * 1.0) * firstHalfTexel
			   + floatGreaterThanOrEqual(float(targetCoord.y), 1.0 * u_textureWidth) * floatLessThan(float(targetCoord.y), u_textureWidth * 2.0) * secondHalfTexel;
	...
	texel.g = floatGreaterThan(u_byteCount, 0.0) * floatLessThanOrEqual(u_byteCount, 1.0) * 0.0
			+ floatGreaterThan(u_byteCount, 1.0) * floatLessThanOrEqual(u_byteCount, 2.0) * 0.0
			+ floatGreaterThan(u_byteCount, 2.0) * floatLessThanOrEqual(u_byteCount, 16.0) * texel.g;
	texel.b = floatGreaterThan(u_byteCount, 0.0) * floatLessThanOrEqual(u_byteCount, 1.0) * 0.0
			...
			+ floatGreaterThan(u_byteCount, 2.0) * floatLessThanOrEqual(u_byteCount, 16.0) * texel.b;
	texel.a = floatGreaterThan(u_byteCount, 0.0) * floatLessThanOrEqual(u_byteCount, 1.0) * floatEquals(mod(floor(gl_FragCoord.x), 4.0), 0.0) * texel.r
			...
			+ floatGreaterThan(u_byteCount, 2.0) * floatLessThanOrEqual(u_byteCount, 16.0) * texel.a;
	...
	float signBitIsSet = floatGreaterThan(u_byteCount, 0.0) * floatLessThanOrEqual(u_byteCount, 1.0) * floatEquals(mod(floor(gl_FragCoord.x), 4.0), 0.0) * floatGreaterThanOrEqual(mostSigTexel.r * 255.0, 128.0)
					   ...
					   + floatGreaterThan(u_byteCount, 2.0) * floatLessThanOrEqual(u_byteCount, 16.0) * floatGreaterThanOrEqual(mostSigTexel.a * 255.0, 128.0);
